...
const Reviews = () => {
    return (
        <div id="resegnas">
            <div className="py-2 sm:py-20 from-rose-50 from-10% via-transparent via-50% to-blue-50 to-100% bg-gradient-to-t bg-opacity-5">
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    ...
                    <div className="mx-auto mt-10 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16  border-gray-200 pt-10 sm:mt-16 sm:pt-16 lg:mx-0 lg:max-w-none lg:grid-cols-3">
                        {posts.map((post) => (
                            <article key={post.id} className="flex max-w-xl flex-col items-start justify-between bg-neutral-50 p-5 border-red-500 border-solid border-4 rounded-3xl shadow-black-600 shadow-xl">
