...
export const eventosList = async () => {
    ...
    try {
        const response = await axiosInstance.get(`/admin/event/all`)
...
export const eventosActivos = async () => {
    try {
        const response = await axiosInstance.get(`/admin/event/all/active`)
        // const response = await apiClient.get ('/evento/')
        //console.log(response.data);
        return response
    } catch (error) {
...
export const eventosNoActivos = async () => {
    try {
        const response = await axiosInstance.get(`/admin/event/all/notActive`)
        // const response = await apiClient.get ('/evento/')
        //console.log(response.data);
        return response
    } catch (error) {
...
export const eventosPost = async (data) => {
    try {
        const response = await axiosInstance.post(`/admin/event/save`, data)
...
export const eventosOne = async (id) => {
    try {
        const response = await axiosInstance.patch(`/admin/event/update/${id}`)
...
export const eventosUpdate = async (data) => {
    try {
        const response = await axiosInstance.patch(`/admin/event/update`, data)
...
export const eventosUpdateOne = async (id, data) => {
    try {
        const response = await axiosInstance.patch(`/admin/event/update/${id}`, data)
        // const response = await apiClient.put ('/evento/${data.id}',data)
        if (response.status === 200) {
            console.log('Evento editado exitosamente');
        }
